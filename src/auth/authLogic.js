...
//   records: [],
// };
// graniteDivider(loginDivider, theme);
/*------------------------
Google Link
-------------------------*/
const googleLink = {
  ...
  options: {
    img_url:
      "https://cdn.addapptation.com/addapptation-customer-assets/addapptation-micros/microdocumentation/google_logo.png",
    img_link: "#",
    img_field_max_width: "100",
    padding_top: "0",
    padding_bottom: "0",
    padding_left: "0",
    padding_right: "0",
...
const sfLink = {
  ...
  options: {
    img_url:
      "https://cdn.addapptation.com/addapptation-customer-assets/addapptation-micros/microdocumentation/salesforce_Logo.png",
    img_link: "#",
    img_field_max_width: "100",
    padding_top: "0",
    padding_bottom: "0",
...
const oktaLink = {
  ...
  options: {
    img_url:
      "https://cdn.addapptation.com/addapptation-customer-assets/addapptation-micros/microdocumentation/okta_Logo.png",
    img_link: "#",
    img_field_max_width: "90",
    padding_top: "0",
    padding_bottom: "0",
    padding_left: "0",
    padding_right: "0",
