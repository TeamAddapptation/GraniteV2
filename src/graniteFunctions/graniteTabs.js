export default function granite_tabs(
  jsonBlock,
  jsonTheme,
  graniteDocument,
  extensions
  ...
  CSS
  ---------------------------------------------*/
  let tabStyles = graniteDocument.createElement("style");
  ...
  graniteDocument.head.appendChild(tabStyles);
  /*---------------------------------------------
    Check for records
    ---------------------------------------------*/
  if (!rCount) {
  ...
  let tabsWrapper = graniteDocument.createElement("div");
  tabsWrapper.classList.add("g__tabs_wrapper");

  let tabsContainer = graniteDocument.createElement("div");
  ...
  r.forEach((r, count) => {
    switch (style) {
      case "step":
        ...
        let stepContainer = graniteDocument.createElement("a");
        ...
        let stepLink = graniteDocument.createElement("div");
        ...
        if (r.name || r.desc) {
          let stepContent = graniteDocument.createElement("div");
          stepContent.classList.add("g__step_content");
          if (r.name) {
            let stepTitle = graniteDocument.createElement("h3");
            stepTitle.classList.add("g__step_title");
            stepTitle.innerHTML = r.name;
            stepContent.appendChild(stepTitle);
          }
          if (r.desc) {
            let stepDesc = graniteDocument.createElement("p");
        ...
        break;
      case "line":
        let tabLineWrap = graniteDocument.createElement("div");
        ...
        if (!!r.icon) {
          let tabLineIcon = graniteDocument.createElement("i");
          tabLineIcon.setAttribute("class", r.icon);
          tabLineWrap.appendChild(tabLineIcon);
        }

        let tabLineLink = graniteDocument.createElement("a");
        ...
        break;
      case "block":
        let tabWrap = graniteDocument.createElement("a");
        ...
        if (!!r.icon) {
          let tabIcon = graniteDocument.createElement("i");
          tabIcon.setAttribute("class", r.icon);
          tabWrap.appendChild(tabIcon);
        }
        let tabLink = graniteDocument.createElement("p");
        ...
        break;
      case "chevron":
        let chevWrap = graniteDocument.createElement("a");
        ...
        if (!!r.icon) {
          let chevIcon = graniteDocument.createElement("i");
          chevIcon.setAttribute("class", r.icon);
          chevWrap.appendChild(chevIcon);
        }
        let chevLink = graniteDocument.createElement("p");
  ...
  /*---------------------------------------------
    Advancer Arrows
    ---------------------------------------------*/
  let leftAdvancer = graniteDocument.createElement("button");
  ...
  let rightAdvancer = graniteDocument.createElement("button");
