...
export default function logic(team) {
  ...
  // function generalStats(name) {
  //   let goalReached = 0;
  //   let quarter = team[name].q1;
  //   Object.keys(quarter).forEach(function (months) {
  //     if (Array.isArray(quarter[months])) {
  //       let actual = quarter[months][1].children[1].value;
  //       let avg = quarter[months][1].children[2].value;
  //       if (actual > avg) {
  //         goalReached += 1;
  //       }
  //     }
